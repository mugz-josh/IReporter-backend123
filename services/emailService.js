...
const emailStyles_1 = require("../styles/emailStyles");
const emailHelper_1 = require("../utils/emailHelper");
class EmailService {
    static async sendReportStatusNotification(userEmail, reportType, reportTitle, oldStatus, newStatus) {
        try {
            ...
            const userMailOptions = {
                ...
                to: userEmailString,
                subject: (0, emailHelper_1.getUserSubject)(reportTypeDisplay),
                html: this.createUserEmailTemplate(userEmailString, reportTypeDisplay, reportTitle, oldStatus, newStatus),
            };
            const adminMailOptions = {
                from: `iReporter System <${process.env.EMAIL_USER}>`,
                to: adminEmail,
                subject: (0, emailHelper_1.getAdminSubject)(reportTypeDisplay),
                html: this.createAdminEmailTemplate(userEmailString, reportTypeDisplay, reportTitle, oldStatus, newStatus),
            };
            await Promise.all([
                email_1.default.sendMail(userMailOptions),
                email_1.default.sendMail(adminMailOptions),
            ]);
    ...
    static createUserEmailTemplate(userEmail, reportType, reportTitle, oldStatus, newStatus) {
        const style = emailStyles_1.emailConstants;
        const reportId = (0, emailHelper_1.generateReportId)();
        const trackingId = (0, emailHelper_1.generateTrackingId)();
        return `
<!DOCTYPE html>
<html>
<head>
  ...
  <style>${(0, emailStyles_1.getBaseStyles)()}</style>
</head>
<body>
  <div class="email-wrapper">
    ...
    <div class="content">
      ...
      <div class="trust-indicators">
        <div class="trust-badge">${(0, emailHelper_1.getLucideIcon)("shield")} Secure</div>
        <div class="trust-badge">${(0, emailHelper_1.getLucideIcon)("lock")} Encrypted</div>
        <div class="trust-badge">${(0, emailHelper_1.getLucideIcon)("check-circle")} Verified</div>
      </div>
        ...
        <tbody>
          <tr>
            ...
            <td>
              ...
              <span class="priority-badge ${(0, emailHelper_1.getPriorityClass)(newStatus)}" style="margin-left: 12px;">
                ${(0, emailHelper_1.getPriorityLevel)(newStatus)}
              </span>
            </td>
          </tr>
          <tr>
      ...
      <div class="status-panel">
        <div class="status-card old">
          ...
          <div class="status-value old-value">
            ${(0, emailHelper_1.getStatusEmoji)(oldStatus)} ${oldStatus.toUpperCase()}
          </div>
        </div>
        ...
        <div class="status-card new">
          ...
          <div class="status-value new-value">
            ${(0, emailHelper_1.getStatusEmoji)(newStatus)} ${newStatus.toUpperCase()}
          </div>
        </div>
      </div>
      ...
      <div class="action-grid">
        <div class="action-card primary">
          <div class="action-icon">${(0, emailHelper_1.getLucideIcon)("eye")}</div>
        ...
        <div class="action-card secondary">
          <div class="action-icon">${(0, emailHelper_1.getLucideIcon)("dashboard")}</div>
        ...
        <div class="action-card support">
          <div class="action-icon">${(0, emailHelper_1.getLucideIcon)("headphones")}</div>
    ...
    static createAdminEmailTemplate(userEmail, reportType, reportTitle, oldStatus, newStatus) {
        const style = emailStyles_1.emailConstants;
        const reportId = (0, emailHelper_1.generateReportId)();
        const userId = (0, emailHelper_1.generateUserId)();
        const changeId = (0, emailHelper_1.generateChangeId)();
        const notificationId = (0, emailHelper_1.generateNotificationId)();
        return `
<!DOCTYPE html>
<html>
<head>
...
<body>
  <div class="email-wrapper">
    ...
    <div class="content">
      <!-- Critical Alert -->
      <div class="alert alert-warning">
        <strong>${(0, emailHelper_1.getLucideIcon)("alert-triangle")} ADMINISTRATIVE ACTION REQUIRED:</strong>
      ...
      <div class="status-panel">
        <div class="status-card">
          ...
          <div class="status-value" style="background: ${style.colors.primary}; color: white;">
            ${(0, emailHelper_1.getStatusIcon)(reportType)} ${reportType}
          </div>
        </div>

        <div class="status-card">
          <div class="status-label">Priority Level</div>
          <div class="status-value ${(0, emailHelper_1.getPriorityClass)(newStatus)}">
            ${(0, emailHelper_1.getPriorityLevel)(newStatus)}
          </div>
        </div>
      </div>
        ...
        <tbody>
          <tr>
            ...
            <td>
              ...
              ${(0, emailHelper_1.getStatusIcon)(oldStatus)}
            </td>
          ...
          <tr>
            ...
            <td>
              <span class="priority-badge ${(0, emailHelper_1.getPriorityClass)(newStatus)}">
                ${newStatus.toUpperCase()}
              </span>
              ${(0, emailHelper_1.getStatusIcon)(newStatus)}
            </td>
      ...
      <div class="action-grid">
        <div class="action-card">
          <div class="action-icon">${(0, emailHelper_1.getLucideIcon)("settings")}</div>
        ...
        <div class="action-card">
          <div class="action-icon">${(0, emailHelper_1.getLucideIcon)("clipboard")}</div>
        ...
        <div class="action-card">
          <div class="action-icon">${(0, emailHelper_1.getLucideIcon)("bar-chart")}</div>
        ...
        <div class="action-card">
          <div class="action-icon">${(0, emailHelper_1.getLucideIcon)("user")}</div>
      ...
      <div class="alert alert-info">
        <strong>${(0, emailHelper_1.getLucideIcon)("clipboard-list")} Administrative Notes:</strong>
